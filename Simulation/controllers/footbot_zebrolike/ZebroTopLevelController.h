...
public:
   ...
   virtual void BecomeCandidate();
	...
	virtual void ReceiveMessage_PATHDATA(ZebroIdentifier senderId, unsigned char messageNumber, ZebroIdentifier intendedReceiver, ZebroIdentifier to, int pathpointsLeft);
