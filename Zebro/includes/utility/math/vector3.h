...
#include <includes/utility/math/general.h>
#include <includes/utility/math/angles.h>
#include <includes/utility/math/vector2.h>
#include <includes/utility/string_utilities.h>
#include <iostream>
#include <cmath>
